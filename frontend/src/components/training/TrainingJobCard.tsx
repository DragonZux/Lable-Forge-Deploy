...
export default function TrainingJobCard({
  ...
  return (
    <Card className="group relative overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5" variant="default">
      {/* Status Bar */}
